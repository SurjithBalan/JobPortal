...
export default function ChattingPage() {
    ...
    return (
        <Container fluid className="bg-light" style={{ minHeight: "100vh", padding: "2rem" }}>
            <Row>
                {/* Left Sidebar */}
                <Col md={4} lg={3}>
                    <div className="p-3">
                ...
                <Col md={8} lg={9}>
                    ...
                    <div className="p-3">                        {/* Header */}
                        ...
                        {/* Chat Box */}
                        <div className="p-3" style={{ height: "400px", overflowY: "auto", background: "#fafafa", borderRadius: "10px" }}>
                            {messages.map((msg, i) => (
                                <div
                                    key={i}
                        ...
                        <InputGroup className=" mb-0" style={{marginTop:'11%'}}>
                            ...
                            />
                            <div className="ms-2">
                                <Button className="px-2 py-2  fw-semibold" style={{ backgroundColor: '#1e88e5', minWidth: '0', minHeight: '0' }}>Send Message</Button>
                            </div>
                        </InputGroup>
                    </div>
                </Col>

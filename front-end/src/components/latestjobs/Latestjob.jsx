            ...
            <Col key={job.id} xs={12} sm={12} md={6} lg={6} xl={6}>
              <div className="job-card py-3 g-2 ">
                  ...
                  <div className="small-card ">
                    ...
                    <div className="body-text  ">
                      <p style={{ color: "#424242" }}>
                        Google / Posted 6d ago / Bangalore
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="d-flex justify-content-between align-items-center pt-2 flex-wrap">
                  <div className="lpa-position">
                    {" "}
                    <span className="fw-bold " style={{ color: "#424242" }}>
                      ₹10-15 LPA
                    </span>
                  </div>
                  <Link to={'/Job_listing_page'}>
                  <Button
                    className="mb-2 text-white fs-6 min-w-0 rounded-pill px-4 viewButton_position"
                    style={{ backgroundColor: "#1e88e5", minWidth: "auto" }}
                  >
                    View More
                  </Button>
                  </Link>

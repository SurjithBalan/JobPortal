...
import './Userbanner_slider_2.css';
import { CiSearch, CiLocationOn } from "react-icons/ci";
import backgroundImage from '../../../assets/image/Backgroung_Image_2.png'
  ...
  return (
    <section className="banner-section2">
      <img
        src={backgroundImage}
        alt=""
        className="img-fluid position-img2"
      />
